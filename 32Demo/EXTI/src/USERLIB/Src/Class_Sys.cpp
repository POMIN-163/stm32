...
void Class_SYS::Init(uint32_t SysTick_CLKSource_HCLK_, u8 SYSCLK) {
...
void Class_SYS::Delay_ms(u16 ms) {
    u8 repeat = ms / 540;
    u16 remain = ms % 540;
    while(repeat) {
        Delay_xms(540);
...
void Class_SYS::Delay_us(u32 us) {
    u32 temp;
...
void Class_SYS::Delay_xms(u16 ms) {
    u32 temp;
